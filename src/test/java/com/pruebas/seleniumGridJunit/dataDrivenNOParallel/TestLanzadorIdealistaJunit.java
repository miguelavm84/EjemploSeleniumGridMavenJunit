...
public class TestLanzadorIdealistaJunit {
	...
	public static Collection testData() throws IOException{
	  ...
	  public TestLanzadorIdealistaJunit(String browser,String versionBrowser,String platformBrowser,String URL_NODE_HUB){
